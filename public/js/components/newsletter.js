function getNewsLetterSection() {
	return [
		...
		`     <input type="email" placeholder="Email" class="w-full lg:w-3/4 p-2 border border-gray-300" />`,
		`     <button class="btn-primary-block-sm lg:btn-primary-sm">Subscribe</button>`,
		`   </div>`,
